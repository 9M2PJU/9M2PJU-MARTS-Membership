            ...
            <header className="flex flex-col md:flex-row justify-between items-center mb-6 md:mb-12 gap-6 relative z-10">
                <div className="text-center md:text-left">
                    ...
                    <p className="text-muted-foreground font-rajdhani tracking-widest uppercase mt-2 text-xs md:text-base">
                        Unofficial Malaysian Amateur Radio Transmitters' Society Membership Database. <br /> Made for 🇲🇾 by <a href="https://hamradio.my" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-amber-400 transition-colors">9M2PJU</a>
                    </p>
                </div>
